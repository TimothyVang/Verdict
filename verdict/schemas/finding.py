"""Finding schema — §3.2 fields present; §3.2/§3.3 validators added in W1.B.10.

artifact_classes (W1.B.8) and caveats_acknowledged (W1.B.9) fields are
present. Enforcement validators (_execution_claims_need_two_classes and
the seven caveat-trigger validators) are added in W1.B.10.
"""
...
class Finding(BaseModel):
    """Vetted forensic conclusion. Fields present; validators added in W1.B.10."""
    ...
    # §3.3 — Tier-1 caveat acknowledgment. Typed list[CaveatID].
