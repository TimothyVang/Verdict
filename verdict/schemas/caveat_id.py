...
CLAUDE.md §3.3 binds these values; renaming or extending requires a
coordinated change across `verdict/prompts/examiner_caveats.md`,
docs/ARCHITECTURE.md §4, and the Finding caveat validators.
"""
