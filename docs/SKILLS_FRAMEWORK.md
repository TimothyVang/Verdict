...
| 3b. Subagent-driven (optional) | `subagent-driven-development` | §3.10 real-services in the subagent's microsandbox too | Two-stage review: spec compliance, then code quality. Maps onto `swarm/` topology — see `docs/AGENT_SWARM.md`. |
