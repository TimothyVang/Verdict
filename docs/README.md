...
| [`DFIR_MEMORY.md`](DFIR_MEMORY.md) | VERDICT's evidence-first memory model: facts vs inference vs unknowns, governed mutation paths, and SANS-aligned conservatism rules. | Before implementing or reviewing the memory store (`src/verdict/memory/`). |
