...
| `05-tldr-original.md` | Initial visual TL;DR with ASCII diagrams. | Promoted to `../README.md` with Devpost-compliance updates (6 judging criteria, deadline correction, etc.) |
