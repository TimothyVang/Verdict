...
| verdict-house-rules (custom) | Verdict — no upstream | n/a | **MIT** (Verdict) | ✅ | **Custom** — Session-start overlay enforcing CLAUDE.md §3 hard rules; wins on conflict with any vendored skill; `.claude/skills/verdict-house-rules/` |
